...
function LoginForm() {
  ...
  async function handleLogin(e: React.FormEvent) {
    ...
    try {
      // Alpha 1: this posts to a local stub route that always succeeds and
      // sets the httpOnly sns_token cookie. Real K-SNS auth (POST
      // /api/v1/auth/token) can be dropped in behind this same route without
      // changing this form.
        ...
        <div className="card p-6">
          <form onSubmit={handleLogin}>
            ...
            <p className="mt-4 text-center text-[11px] text-gray-600">
              Alpha 1 baseline — authentication is a local stub. Real K-SNS
              auth is not yet wired up.
            </p>
          </form>
        </div>
